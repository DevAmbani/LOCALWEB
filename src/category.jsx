...
function Category() {
    ...
    return (
        <div>
            ...
            <Card style={{ backgroundcolor:'#fffffff',backgroundSize: 'cover',
                ...
                <CardContent>
                        ...
                        <Grid container style={{ marginTop: '0.5%',  justifyContent: 'center'}} spacing={3}>
                            ...
                            <Grid item xs={10} sm={9} md={4} >
                                <Card className="card" onMouseEnter={() => setIsEventsHovered(true)} onMouseLeave={() => setIsEventsHovered(false)}  onClick={()=>handleCardClick("events")} 
                                  style={{ maxWidth: '85%', maxHeight: '100%',  ...getCardBorderStyle("events") ,borderRadius: '0px', boxShadow: '0 4px 8px rgba(50, 50, 50, 0.5)', background: '#E2E8F0', transform: isEventsHovered ? 'scale(1.05)' : 'scale(1)' , transition: 'transform 0.5s ease', cursor: 'pointer' }}>
                            ...
                            <Grid item xs={10} sm={9} md={4} >
                                ...
                                style={{ maxWidth: '85%', maxHeight: '100%', ...getCardBorderStyle("eateries") , borderRadius: '0px', boxShadow: '0 4px 8px rgba(50, 50, 50, 0.5)', background:'#E2E8F0', transform: isEateriesHovered ? 'scale(1.05)' : 'scale(1)', transition: 'transform 0.5s ease', cursor: 'pointer' }}>
                            ...
                            <Grid item xs={10} sm={9} md={4} >
                               ...
                               style={{ marginTop:'2%' , maxWidth: '85%', maxHeight: '100%',  ...getCardBorderStyle("activities") , borderRadius: '0px',  boxShadow: '0 4px 8px rgba(50, 50, 50, 0.5)', background:'#E2E8F0', transform: isActivitiesHovered ? 'scale(1.05)' : 'scale(1)', transition: 'transform 0.5s ease', cursor: 'pointer' }}>
                                    <CardContent style={{ padding: '0%', position: 'relative' }}>
                        ...
                        <Button  variant="contained" onClick={handleContinue}  onMouseEnter={() => setIsButtonHovered(true)} onMouseLeave={() => setIsButtonHovered(false)} style={{fontSize:'18px',width:'18%',height:'55px', marginLeft: '41%', marginTop:'50px', border: '#ffffff solid 3px', borderRadius: '20px', backgroundColor:'#4318FF', transform: isButtonHovered ? 'scale(1.05)' : 'scale(1)', transition: 'transform 0.5s ease', cursor: 'pointer', color:'#ffffff', fontWeight:'500' }}>
                        CONTINUE</Button>
